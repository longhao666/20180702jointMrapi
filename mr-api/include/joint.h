...
// 摩擦力模型
#define TC_COUL_COEFF         0x80    // ‰  库伦摩擦力补偿系数
#define TC_FRICRISE_COEFF     0x81    // 万分之一，上升趋势

#define TC_COUL_P             0x82    // 常温25℃库伦摩擦 mA
#define TC_COUL_N             0x83    // 常温25℃库伦摩擦 mA
#define TC_VISCOEFF_P         0x84    // 常温25℃最大速度时粘滞摩擦 mA
#define TC_VISCOEFF_N         0x85    // 常温25℃最大速度时粘滞摩擦 mA
#define TC_COUL_TEMP_P        0x86    // 库伦摩擦温度系数 mA/℃
#define TC_COUL_TEMP_N        0x87    // 库伦摩擦温度系数 mA/℃
#define TC_VISCOEFF_TEMP_P    0x88    // 粘滞摩擦温度系数 mA/℃
#define TC_VISCOEFF_TEMP_N    0x89    // 粘滞摩擦温度系数 mA/℃

#define TC_OSC_DEDUC          0x8A   // ％ ，震荡幅值占库伦摩擦的比例
#define TC_OSC_FREQ           0x8B   // 十分之一，震荡频率
#define TC_ZEROVEL_THR        0x8C   // 百分之一RPM，零速度
#define TC_CRITACC_THR        0x8D   // 百分之一RPM/s，零加速度
#define TC_STARTUP_TW         0x8E   // 1/2K s
#define TC_STOP_TW            0x8F   // 1/2K s
...
//刹车控制命令
#define BRAKE_RELEASE_CMD		  0x9E		//刹车释放命令，0-保持制动，1-释放刹车
#define BRAKE_STATE				  0x9F    //刹车状态，0-保持制动，1-释放刹车
